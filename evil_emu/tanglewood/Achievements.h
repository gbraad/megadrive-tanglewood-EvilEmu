...
public:
	...
	void RegisterWatchers(DataBridge& dataBridge);
	void OnUserLoggedIn(ion::services::User& user);
	...
	static ion::services::Achievement s_achievements[ACH_COUNT];
...
private:
	ion::services::Achievements* m_achievementsSystem;
	ion::services::User* m_achievementsUser;
};
